...
namespace Server.Gumps
{
	public class KRGumpImage : GumpEntry
	{
		...
		public KRGumpImage( int x, int y, int gumpID ) : this( x, y, gumpID, 0 )
		{
		}

		public KRGumpImage( int x, int y, int gumpID, int hue )
		{
			m_X = x;
			m_Y = y;
			m_GumpID = gumpID;
		...
		public override string Compile()
		{
			if ( m_Hue == 0 )
				...
				return String.Format( "{{ kr_gumppic {0} {1} {2} hue={3} }}", m_X, m_Y, m_GumpID, m_Hue );
		}
