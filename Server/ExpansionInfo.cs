		...
		private static ExpansionInfo[] m_Table = new ExpansionInfo[]
			{
				...
				//Before 59.0.2 new ExpansionInfo( 4, "Kingdom Reborn"  , new ClientVersion( "6.0.1.4" ),				0xA2DF, 0x7A8 , 0x2E0 )
				//OLD new ExpansionInfo( 4, "Kingdom Reborn"  , new ClientVersion( "6.0.1.4" ),				0xA0DF, 0x2FA8, 0x2E0 ) //0x2000(KR Faces),0x200(Kr Flag1) + 0x400(Kr Flag2) for KR + Other to Complate Osi Flags
				new ExpansionInfo( 4, "Kingdom Reborn"  , new ClientVersion( "6.0.1.4" ),    0x62DF, 0x7A8 , 0x2E0 ),//E0DB-In Osi //After 2.59.0.2 80DB
				//CHECK FLAGS
				new ExpansionInfo( 5, "Stygian Abyss"  , new ClientVersion( "6.0.14.2" ),    0x162DF, 0x7A8 , 0x2E0 )//SA flag1 0x10000
			};
